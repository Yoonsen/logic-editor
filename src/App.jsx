...
const SYMBOL_SECTIONS = [
  ...
  },
  {
    ...
    symbols: [
      ...
      { symbol: "&", desc: "with (additive conjunction)" },
      { symbol: "⊕", desc: "plus (additive disjunction)" },
      { symbol: "⊥", desc: "bottom (false)" },
      { symbol: "⊤", desc: "top (truth)" },
      { symbol: "1", desc: "multiplicative unit" },
      { symbol: "0", desc: "additive zero" },
  ...
  },
  {
    ...
    symbols: [
      ...
      { symbol: "ν", desc: "nu" },
      { symbol: "ξ", desc: "xi" },
      { symbol: "ο", desc: "omicron" },
      { symbol: "π", desc: "pi" },
      { symbol: "ρ", desc: "rho" },
      { symbol: "σ", desc: "sigma" },
      { symbol: "ς", desc: "sigma (final)" },
      { symbol: "τ", desc: "tau" },
      { symbol: "υ", desc: "upsilon" },
      { symbol: "φ", desc: "phi" },
      { symbol: "χ", desc: "chi" },
      { symbol: "ψ", desc: "psi" },
      { symbol: "ω", desc: "omega" },
      { symbol: "ϑ", desc: "vartheta" },
      { symbol: "ϕ", desc: "varphi" },
      { symbol: "ϖ", desc: "varpi" },
    ],
  },
  {
